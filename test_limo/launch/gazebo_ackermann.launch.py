...
def generate_launch_description():
    ...
    urdf_file_path = "gazebo/ackermann_with_sensor.xacro"
    world_path = "/usr/share/gazebo-11/worlds/empty.world"

    pkg_share = FindPackageShare(package=package_name).find(package_name)
    limo_car_share = FindPackageShare(package=limo_car).find(limo_car)
    ...
    default_urdf_model_path = os.path.join(limo_car_share, urdf_file_path)
    robot_description_config = xacro.process_file(default_urdf_model_path)
